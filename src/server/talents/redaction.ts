...
// NUMBERS: t-engine4 game/modules/tome/data/talents/chronomancy/temporal-combat.lua:296-335 -- Breach
//          `cooldown = 8` in ACTIONS, taken unconverted and argued at
//          `COOLDOWN` below. The INK COST and the RANGE are AUTHORED:
...
// SHAPE:   t-engine4 game/modules/tome/data/talents/chronomancy/temporal-combat.lua:296-335 -- Breach
