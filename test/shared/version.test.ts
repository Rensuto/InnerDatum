...
describe('shared constants', () => {
  ...
  it('pins PROTOCOL_VERSION at 13 — a second map can arrive mid-session', () => {
  ...
  it('keeps the 12 -> 13 changelog entry beside the constant, and non-empty', () => {
    ...
    const afterHeading = source.split('12 -> 13')[1] ?? '';
    ...
    // NOT bumping.
    expect(entry).toContain('SitesMsg');
